...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.ViewHolder> {
    ...
    public GridAdapter(Context context, List<ShopBean.DataBean> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View  itemView=View.inflate(context, R.layout.rv_item_grid,null);
    ...
    //定义成员变量
    private RecycleAdapter.OnItemClick mOnItemClick;

    //设置方法暴露给外界
    public void setOnItemClickListener(RecycleAdapter.OnItemClick onItemClick) {
